...
#define UNIQUE_COLORS_TABLE_NUM2_SIZE 24
...
static const vec3_t UniqueColorTableNum2[UNIQUE_COLORS_TABLE_NUM2_SIZE] =
{
	{ 0, 1, 0 },        /* Green */
	{ 1, 1, 0 },        /* Yellow */
	{ 0, 1, 1 },        /* Cyan */
...
#define UNIQUE_COLOR(CI) ((cg_switchUniqueColors.integer) ? UniqueColorTableNum2[(CI) % UNIQUE_COLORS_TABLE_NUM2_SIZE] : uniqueColorTable[(CI) % UNIQUE_COLORS_TABLE_SIZE])
