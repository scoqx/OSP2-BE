...
Показывать ли оружие. Добавлена поддержка битмаски, для значений 2, 4, 8 и 16
...
---
    ...
    cg_lightningOpaque 0.0-1.0

0 - делает луч шафта игрока прозрачным, 1 - шафт непрозрачный по умолчанию, если задать значение 0.5 то шафт будет полупрозрачный
...
Проигрывать предупреждение после разморозки в режиме freezeTag
...
---
    ...
    cg_teamLightnings 0/1

Раскраска луча шафта в красный и синий цвета для идентификации свой / чужой.

`0` обычная раскраска - "белый" для всех

`1` чужие всегда красным, свои всегда синим, собственный всегда белым
